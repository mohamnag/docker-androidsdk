...
RUN mkdir -p $ANDROID_HOME && \
    ...
    ( sleep 5 && while [ 1 ]; do sleep 1; echo y; done ) | android update sdk --no-ui -a --filter platform-tools,${ANDROID_VERSION},${BUILD_TOOLS_VERSION},extra-android-m2repository,extra-android-support,extra-android-m2repository
# clean up
